...
path2='./data/reconstructed_creditcard.csv'
...
data_set = pd.concat([normal[:2000], anomalies,df2])
#data_set=data_set[data_set['Class']<=2]
...
drop_5=GRU(64)(drop_4)
#Flatten layer to feed into the output layer
#flat = Flatten()(drop_5)

output_layer = Dense(2, activation='softmax')(drop_5)
