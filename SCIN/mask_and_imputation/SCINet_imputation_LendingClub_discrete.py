...
#anomalies.to_csv("./data/LendingClub_data/anomalies.csv", index=False)
#print("ok")
...
torch.save(model.state_dict(), "./train_result/LendingClub/my_model.pth")
torch.save(optimizer.state_dict(), "./train_result/LendingClub/my_optimizer.pth")
...
reconstructed_df = pd.DataFrame(reconstructed_data.reshape(-1,64))

reconstructed_df=reconstructed_df.drop(columns=62,axis=1)

reconstructed_df=reconstructed_df.drop(columns=63,axis=1)
...
reconstructed_df.to_csv("./data/LendingClub_data/reconstructed_lendingclub.csv", index=False)
